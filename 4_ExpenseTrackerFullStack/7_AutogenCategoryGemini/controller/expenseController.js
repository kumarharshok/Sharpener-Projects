...
const GOOGLE_API_KEY = "AIzaSyBC4mnKAtj-7TMeZZ3kDkmKLHbfHdQA6KQ";
...
const addExpense = async (req, res) => {
    ...
    try {
        ...
        await expenseTable.create({amount, description, category: category.text, userId}, { transaction: t });

        await userTable.increment({totalExpenses: amount}, {where: {id: userId}, transaction: t});
