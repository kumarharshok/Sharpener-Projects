...
const deleteExpense = async (req, res) => {
    ...
    try {
        ...
        const expense = await expenseTable.findOne({where: {id: expsenseId}});

        await expenseTable.destroy({where: {id : expsenseId}});

        await userTable.decrement({totalExpenses: expense.amount}, {where: {id: expense.userId}});
